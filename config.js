...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "ANESU ISHE ELECTRICAL SERVICES AND SOLAR SYSTEMS",
    phone:     "+27 67 844 1164",
    whatsapp:  "+27 67 844 1164",
    address:   "47 Long St, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "ANESU ISHE ELECTRICAL SERVICES AND SOLAR SYSTEMS — Electrician in randburg",
    description: "ANESU ISHE ELECTRICAL SERVICES AND SOLAR SYSTEMS provides professional electrician in Randburg. 1 Google review. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "ANESU ISHE ELECTRICAL SERVICES AND SOLAR SYSTEMS handles residential and commercial electrical work across Randburg. Fault-finding, DB board repairs, compliance certificates and new installations.",
    ...
    band: {
      ...
      alt:   "ANESU ISHE ELECTRICAL SERVICES AND SOLAR SYSTEMS team at work in Randburg",
      text:  "Professional electrical work — done right, first time."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Randburg. Serving the wider area.",
    areasLead:  "We work across Randburg, Northcliff, Cresta and the surrounding suburbs.",
